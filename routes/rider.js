...
router.get('/', async function(req, res, next) {
  ...
  const confirmedRides = await db.ride.listConfirmedRidesForRider(1, db.exposedInstance)
  const pendingBids = await db.bid.listPendingBidsForUser(1, db.exposedInstance);
