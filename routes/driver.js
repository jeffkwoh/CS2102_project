...
router.get('/', async function(req, res, next) {
  ...
  const confirmedRides = await db.ride.listConfirmedRidesForDriver(driverId, db.exposedInstance)
  const pendingRides = await db.ride.listPendingRidesForDriver(driverId, db.exposedInstance)
